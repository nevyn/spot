<?php
/*
 * $Id: browsetrack.php 3 2009-02-24 21:58:43Z despotify $
 * Browse track meta data
 *
 */
...
if(strlen($id) != 32 || !preg_match("/[0-9a-f]{32}/", $id))
	die($xml_decl . "<despotify><errorcode>30</errorcode><errormessage>Need parameter 'id' (16 bytes track ID in hexadecimal notation)</errormessage></despotify>");


socket_write($fd, "browsetrack $id\n");
